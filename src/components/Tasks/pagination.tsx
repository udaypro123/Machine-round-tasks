...
const Pagination: React.FC<Props> = ({ }) => {
	...
	return (
		<>
			<Grid container sx={{marginTop: "5rem", marginLeft: "7rem", width: "98%", bgcolor: "lightgrey", borderRadius: "1rem", display: "flex", justifyContent: "center", alignItems: "center"}} >
			...
			<Grid sx={{width: "99vw", marginTop: "3rem", display: "flex", justifyContent: "space-around", }} >
